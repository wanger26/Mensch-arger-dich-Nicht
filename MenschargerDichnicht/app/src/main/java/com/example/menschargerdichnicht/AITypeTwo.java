...
/**
 * This players attempts to move the most backward piece forward if possible to try and get all pieces on the board to the finish spots simultaneously
 */
public class AITypeTwo implements AI{
